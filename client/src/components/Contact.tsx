...
export default function Contact(props: ContactProps) {
    ...
    const handlePhoneCall = () => {
        const phoneNumber = config.contact.contactInfo.phone;
        const isMobileDevice = /Android|iPhone|iPad|iPod|Windows Phone|IEMobile|Opera Mini/i.test(navigator.userAgent);
        ...
        window.alert(`Please call ${phoneNumber} from your phone.`);
    };
